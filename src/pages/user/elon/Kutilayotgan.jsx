...
export default function Kutilayotgan() {
  return (
    <div>
      <h1 className="text-2xl font-bold">Kutilayotgan e'lonlar</h1>
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        {data.map((item, index) => (
          <Grid item xs={4} key={index}>
            <div className="drop-shadow-xl p-4 bg-white mt-5 rounded-xl">
              <div className="rounded-3xl  bg-none pl-0 p-4 pb-2 pt-2 text-[#40bf30] hover:scale-105 duration-300">
                Tez orada joylanadi
              </div>

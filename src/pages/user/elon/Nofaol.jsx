...
export default function Radetilgan() {
  return (
    <div>
      <h1 className="text-2xl font-bold">Rad etilgan e'lonlar</h1>
        ...
        {data.map((item, index) => (
          <Grid item xs={4} key={index}>
            <div className="drop-shadow-xl p-4 bg-white mt-5 rounded-xl">
              ...
              <hr className="m-3" />
              <div className="flex justify-between">
                <div className="rounded-3xl border-2 border-[#40bf30] bg-none p-4 pb-2 pt-2 text-[#40bf30] hover:scale-105 duration-300">
                  <Link
                    to={"/chake"}
                    variant="primary"
                    type="Submit"

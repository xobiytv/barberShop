...
export default function SalonProfel(props) {
    const settings = {
      slidesToShow: 1,
      slidesToScroll: 1,
      autoplay: true,
    ...
    <div>
      ...
      <div className="flex p-3 ml-3 mr-3  rounded-2xl justify-between">
        ...
        >
          ...
          <div className="flex w-1/6 justify-end">
            <Link
              to={"/"}
              className="bg-[#FB9400] h-9 pl-5 pr-3 pt-1 pb-1 text-center rounded-3xl text-white py-2
      ...
      <div className="ml-5 mr-5 ">
        <ul className="flex justify-between mb-4">
          ...
          <li className=" ">
            <Link className="m-0 text-center" to={"/call"}>
              <div className="w-12 translate-y-5 rounded-full h-12 bg-[#FDF1DF] items-center  flex justify-center ">
                <CallIcon
                  color="action"
                  sx={{ fontSize: 24, color: "#FB9400 " }}

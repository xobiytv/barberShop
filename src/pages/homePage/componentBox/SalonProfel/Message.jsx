...
export default function Message() {
  return (
    <div>
      ...
      <div class="flex flex-col pb-16 items-center justify-center w-screen min-h-screen bg-gray-100 text-gray-800 ">
      ...
      <Paper
        ...
        // elevation={3}
      >
        <div class="flex items-center bg-[#fff] justify-between w-full p-3 border-t border-gray-300">
          <button>
            <svg
